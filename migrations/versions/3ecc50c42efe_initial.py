...
Revision ID: 3ecc50c42efe
Revises: 6c12b2e32f6b
Create Date: 2023-02-21 18:27:26.616907
...
revision = '3ecc50c42efe'
down_revision = '6c12b2e32f6b'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('registrered_at', sa.TIMESTAMP(), nullable=True),
...
def downgrade() -> None:
    ...
    sa.Column('registrered_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
